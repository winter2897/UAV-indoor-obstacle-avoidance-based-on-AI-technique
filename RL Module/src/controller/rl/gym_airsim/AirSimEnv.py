...
from myAirSimClient import myAirSimClient
...
class AirSimEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.goal = 	[0, 0] # global xy coordinates
    ...
    def computeReward(self, now):
        ...
        # print('\n', r, distance_before, distance_now)
            
        return r, distance_now
		
    def collision_check(self, action):
         collided = argym.take_action(action)
         return collided
